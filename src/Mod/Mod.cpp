...
Mod::Mod() :
	...
	_performanceBonusFactor(0), _enableNewResearchSorting(false), _useCustomCategories(false), _shareAmmoCategories(false), _showDogfightDistanceInKm(false), _showFullNameInAlienInventory(false),
