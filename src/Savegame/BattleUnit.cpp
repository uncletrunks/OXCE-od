...
BattleUnit::BattleUnit(Soldier *soldier, int depth, int maxViewDistance) :
	...
	_geoscapeSoldier(soldier), _unitRules(0), _rankInt(0), _turretType(-1), _hidingForTurn(false), _floorAbove(false), _respawn(false), _capturable(CAP_DEFAULT), _alreadyRespawned(false), _isLeeroyJenkins(false)
{
